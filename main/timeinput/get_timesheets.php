...
?>
     ...
     <div data-role="collapsible-set" data-theme="a" data-inset="false">
		...
		?>
            ...
            <ul data-role="listview" data-theme="a" class="ui-listview-noborder" >
                <?php
			 	switch($type) {
					case 'Date':
						foreach ($bootstrap->get_timesheets('date',$_GET['date']) as $array ) {
							...
							if( $current_jobid != $job_id )	 {
								...
								$divider = '<li data-theme="a" data-role="list-divider" >Job ID: '.$job_id.'</li>';	
								echo $divider;
							}
					...
					case 'Job ID':
						foreach ($bootstrap->get_timesheets('job_id',$_GET['job_id']) as $array ) {
							...
							if( $current_date != $date )	 {
								$current_date = $date;
								$divider = '<li data-theme="a" data-role="list-divider" >Date: '.$date.'</li>';	
								echo $divider;
							}
